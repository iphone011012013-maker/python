...
MY_ID = 1431886140  # ✅ تم تثبيت الآيدي الخاص بك

bot = telebot.TeleBot(TOKEN)

# --- الإعدادات ---
SCREENSHOT_INTERVAL = 10  # ✅ تم تعديل التوقيت ليكون كل 10 ثوانٍ
...
SAVE_DIR = os.path.join(DESKTOP_PATH, "محمود_System_Final")
...
# ==========================================
# 3. أنظمة المراقبة (Screen & Camera)
# ==========================================
...
def create_main_keyboard():
    ...
    markup.add('🔈 التحكم في الصوت') # تم فصله ليكون وحده
    return markup
...
def start_command(message):
    if is_authorized(message.chat.id):
        bot.reply_to(message, "✅ **نظام التحكم جاهز (V18)**", reply_markup=create_main_keyboard())
